...
- Call it: `dots-studio/dots-3-note-preview:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `dots-studio/dots-3-note-preview:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `dots-3-note-preview-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
