...
# Where glm-4.6 is free

**One row on the list serves `glm-4.6` free:** AIHubMix (free models). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/glm-4-6), below its strong bar.
