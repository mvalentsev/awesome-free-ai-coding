...
- Call it: `novita/inclusionai/ling-3.0-tiny` at `https://router.requesty.ai/v1`, with a key in `REQUESTY_API_KEY` from <https://app.requesty.ai/api-keys>
...
- Call it: `ling-3.0-tiny-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
