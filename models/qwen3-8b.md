...
- Call it: `qwen3-8b` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
...
🔌 LLM APIs with free tier · no card · provisional since 2026-09-19 · verified 2026-09-24 · listed since 2026-09-19
...
- Call it: `Qwen/Qwen3-8B`, `deepseek-ai/DeepSeek-R1-0528-Qwen3-8B` at `https://api.siliconflow.cn/v1`, with a key in `SILICONFLOW_CN_API_KEY` from <https://cloud.siliconflow.cn/account/ak>
