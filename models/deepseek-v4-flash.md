...
- Call it: `deepseek-v4-flash:free` at `https://api.routeway.ai/v1`, with a key in `ROUTEWAY_API_KEY` from <https://routeway.ai/dashboard/keys>
...
- Call it: `deepseek-v4-flash` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
...
- Call it: `deepseek-v4-flash` at `https://freeinference.org/v1`, with a key in `FREEINFERENCE_API_KEY` from <https://freeinference.org>
