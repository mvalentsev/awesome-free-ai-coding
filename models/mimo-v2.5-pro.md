---
layout: default
title: 'mimo-v2.5-pro free: 1 provider, limits and ids, verified 2026-09-24'
description: mimo-v2.5-pro is served free by AIHubMix (free models). It asks for no card. Each one's limits in the vendor's words, the ids to call and the day a live probe last confirmed it.
