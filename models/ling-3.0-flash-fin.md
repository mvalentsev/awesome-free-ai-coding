...
🤖 Coding agents & CLIs · no card · verified 2026-09-24 · listed since 2026-08-30
...
- Call it: `inclusionai/ling-3.0-flash-fin:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `inclusionai/ling-3.0-flash-fin:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `inclusionai/ling-3.0-flash-fin` at `https://llmtr.com/v1`, with a key in `LLMTR_API_KEY` from <https://llmtr.com/dashboard/api-keys>
...
- Call it: `inclusionai/ling-3.0-flash-fin`, `inclusionai/ling-3.0-flash-fin-free` at `https://ai-gateway.vercel.sh/v1`, with a key in `VERCEL_AI_GATEWAY_API_KEY` from <https://vercel.com/dashboard/ai-gateway/api-keys>
