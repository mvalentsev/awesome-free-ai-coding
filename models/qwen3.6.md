...
- Call it: `qwen/qwen3.6-27b` at `https://api.groq.com/openai/v1`, with a key in `GROQ_API_KEY` from <https://console.groq.com/keys>
...
- Call it: `Qwen/Qwen3.6-35B-A3B-FP8` at `https://inference.hetzner.com/api/v1`, with a key in `HETZNER_INFERENCE_API_KEY` from <https://experiments.hetzner.com/inference>
...
- Call it: `qwen3.6-35b` at `https://freeinference.org/v1`, with a key in `FREEINFERENCE_API_KEY` from <https://freeinference.org>
...
- Call it: `Qwen3.6-27B` at `https://oai.endpoints.kepler.ai.cloud.ovh.net/v1`, with no key
