...
- Call it: `thinkingmachines/inkling-small:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `thinkingmachines/inkling-small:free` at `https://api.kilo.ai/api/gateway`, with no key
