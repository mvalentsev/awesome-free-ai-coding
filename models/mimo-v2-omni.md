---
layout: default
title: 'mimo-v2-omni free: 1 provider, limits and ids, verified 2026-09-24'
description: mimo-v2-omni is served free by AIHubMix (free models). It asks for no card. Each one's limits in the vendor's words, the ids to call and the day a live probe last confirmed it.
permalink: /models/mimo-v2-omni/
...
# Where mimo-v2-omni is free

**One row on the list serves `mimo-v2-omni` free:** AIHubMix (free models). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/mimo-v2-omni), below its strong bar.
...
- Callable ids: `xiaomi-mimo-v2-omni-free`
