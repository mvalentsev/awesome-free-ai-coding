---
layout: default
title: 'qwen3-coder-next free: 2 providers, limits and ids, verified 2026-09-24'
...
**2 rows on the list serve `qwen3-coder-next` free:** Kiro and Alibaba Cloud Model Studio (DashScope, international). None asks for a card. A live probe confirmed each one on 2026-09-24 and reads them again twice a week.
...
- Inside Kiro itself: no API endpoint to paste
...
- Call it: `qwen3-coder-next` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
