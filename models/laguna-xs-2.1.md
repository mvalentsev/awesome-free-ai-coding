...
- Call it: `poolside/laguna-xs-2.1:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `poolside/laguna-xs-2.1:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `poolside/laguna-xs-2.1` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `laguna-xs-2.1-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
...
- Call it: `poolside/laguna-xs-2.1` at `https://llmtr.com/v1`, with a key in `LLMTR_API_KEY` from <https://llmtr.com/dashboard/api-keys>
