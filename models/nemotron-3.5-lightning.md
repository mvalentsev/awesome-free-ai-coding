---
layout: default
title: 'nemotron-3.5-lightning free: 6 providers, limits and ids, verified 2026-09-24'
...
**6 rows on the list serve `nemotron-3.5-lightning` free:** opencode, OpenRouter (free models), Kilo Code, Requesty, NVIDIA NIM (build.nvidia.com) and AIHubMix (free models). None asks for a card; Kilo Code answers with no account at all. A live probe confirmed each one on 2026-09-24 and reads them again twice a week.
...
🤖 Coding agents & CLIs · no card · verified 2026-09-24 · listed since 2026-08-14
...
- Inside opencode itself: no API endpoint to paste
...
- Call it: `nvidia/nemotron-3.5-lightning:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `nvidia/nemotron-3.5-lightning:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `nvidia/nemotron-3.5-lightning-30b-a3b` at `https://router.requesty.ai/v1`, with a key in `REQUESTY_API_KEY` from <https://app.requesty.ai/api-keys>
...
- Call it: `nvidia/nemotron-3.5-lightning-30b-a3b` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `nemotron-3.5-lightning-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
