...
- Call it: `gemini-3.7-flash` at `https://generativelanguage.googleapis.com/v1beta/openai/`, with a key in `GOOGLE_AI_STUDIO_API_KEY` from <https://aistudio.google.com/apikey>
