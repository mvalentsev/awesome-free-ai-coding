---
layout: default
title: 'gemini-3.5-flash free: 1 provider, limits and ids, verified 2026-09-24'
description: gemini-3.5-flash is served free by Google AI Studio (Gemini API). It asks for no card. Each one's limits in the vendor's words, the ids to call and the day a live probe last confirmed it.
permalink: /models/gemini-3.5-flash/
last_modified_at: 2026-09-25
crumb: gemini-3.5-flash
---

{% raw %}

# Where gemini-3.5-flash is free

**One row on the list serves `gemini-3.5-flash` free:** Google AI Studio (Gemini API). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/gemini-3-5-flash), below its strong bar.
...
- [Google Antigravity](https://mvalentsev.github.io/awesome-free-ai-coding/providers/antigravity/) — listed 2026-08-11 to 2026-09-03
