...
- Call it: `google/gemma-4-31b-it:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `google/gemma-4-31b-it` at `https://router.requesty.ai/v1`, with a key in `REQUESTY_API_KEY` from <https://app.requesty.ai/api-keys>
...
- Call it: `google/gemma-4-31b-it` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `gemini/gemma-4-31b` at `https://api.opper.ai/v3/compat`, with a key in `OPPER_API_KEY` from <https://platform.opper.ai/settings/api-keys>
