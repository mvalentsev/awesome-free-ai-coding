...
- Call it: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` at `https://router.requesty.ai/v1`, with a key in `REQUESTY_API_KEY` from <https://app.requesty.ai/api-keys>
...
- Call it: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `nemotron-3-nano-omni-30b-a3b-reasoning-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
...
- Call it: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` at `https://api.tokenrouter.com/v1`, with a key in `TOKENROUTER_API_KEY` from <https://www.tokenrouter.com/console/token>
