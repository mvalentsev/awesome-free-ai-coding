---
layout: default
title: 'glm-5.3 free: 1 provider, limits and ids, verified 2026-09-24'
...
**One row on the list serves `glm-5.3` free:** AIHubMix (free models). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **strong**: within 25 points of the top of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/glm-5-3).
...
- Call it: `coding-glm-5.3-flash-free`, `coding-glm-5.3-free` at `https://aihubmix.com/v1`, with a key in `AIHUBMIX_API_KEY` from <https://aihubmix.com/token>
