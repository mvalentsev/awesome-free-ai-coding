...
- Call it: `nvidia/muse-glimmer-30b` at `https://router.requesty.ai/v1`, with a key in `REQUESTY_API_KEY` from <https://app.requesty.ai/api-keys>
...
- Call it: `meta/muse-glimmer-30b` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `muse-glimmer-30b:free` at `https://api.routeway.ai/v1`, with a key in `ROUTEWAY_API_KEY` from <https://routeway.ai/dashboard/keys>
