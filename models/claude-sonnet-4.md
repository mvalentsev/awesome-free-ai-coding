---
layout: default
title: 'claude-sonnet-4 free: 1 provider, limits and ids, verified 2026-09-24'
description: claude-sonnet-4 is served free by Kiro. It asks for no card. Each one's limits in the vendor's words, the ids to call and the day a live probe last confirmed it.
permalink: /models/claude-sonnet-4/
last_modified_at: 2026-09-26
crumb: claude-sonnet-4
---

{% raw %}

# Where claude-sonnet-4 is free

**One row on the list serves `claude-sonnet-4` free:** Kiro. It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/claude-4-sonnet), below its strong bar.
...
- [`claude-opus-4.6`](https://mvalentsev.github.io/awesome-free-ai-coding/models/claude-opus-4.6/) — free at Google Antigravity
- [`claude-sonnet-4.5`](https://mvalentsev.github.io/awesome-free-ai-coding/models/claude-sonnet-4.5/) — free at Kiro
- [`claude-sonnet-4.6`](https://mvalentsev.github.io/awesome-free-ai-coding/models/claude-sonnet-4.6/) — free at Google Antigravity
