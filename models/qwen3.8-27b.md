...
- Call it: `qwen/qwen3.8-27b` at `https://api.groq.com/openai/v1`, with a key in `GROQ_API_KEY` from <https://console.groq.com/keys>
...
- Call it: `nvidia/Qwen3.8-27B-NVFP4` at `https://api.llmtech.eu/v1`, with the key the vendor prints for anyone at <https://llmtech.eu/docs/>, `lt-trial-ba1ef28c6d32ed6980678d8d`
...
- Call it: `Qwen3.8-27B` at `https://inference.hetzner.com/api/v1`, with a key in `HETZNER_INFERENCE_API_KEY` from <https://experiments.hetzner.com/inference>
...
- Call it: `qwen3.8-27b` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
...
- Call it: `qwen3.8-27b` at `https://api.regolo.ai/v1`, with a key in `REGOLO_API_KEY` from <https://dashboard.regolo.ai>
...
- Call it: `qwen/qwen3.8-27b` at `https://gateway.vlm.run/v1/openai`, with no key
...
- Call it: `Qwen3.8-27B` at `https://oai.endpoints.kepler.ai.cloud.ovh.net/v1`, with no key
