...
- Call it: `openai/gpt-oss-20b` at `https://api.groq.com/openai/v1`, with a key in `GROQ_API_KEY` from <https://console.groq.com/keys>
...
- Call it: `openai/gpt-oss-20b` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `gpt-oss-20b` at `https://text.pollinations.ai/openai`, with no key
