...
- Call it: `inclusionai/ling-3.0-flash-sante:free` at `https://openrouter.ai/api/v1`, with a key in `OPENROUTER_API_KEY` from <https://openrouter.ai/settings/keys>
...
- Call it: `inclusionai/ling-3.0-flash-sante:free` at `https://api.kilo.ai/api/gateway`, with no key
...
- Call it: `inclusionai/ling-3.0-flash-sante`, `inclusionai/ling-3.0-flash-sante-free` at `https://ai-gateway.vercel.sh/v1`, with a key in `VERCEL_AI_GATEWAY_API_KEY` from <https://vercel.com/dashboard/ai-gateway/api-keys>
