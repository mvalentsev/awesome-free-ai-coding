...
**2 rows on the list serve `muse-spark-1.3-contributor` free:** opencode and Cline. None asks for a card. A live probe confirmed each one on 2026-09-24 and reads them again twice a week. It measures **strong**: within 25 points of the top of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/muse-spark-1-3-xhigh).
...
🤖 Coding agents & CLIs · no card · provisional since 2026-09-14 · verified 2026-09-24 · listed since 2026-09-24
...
- Inside Cline: pick `cline-free/muse-spark-1.3-contributor` in its model list
