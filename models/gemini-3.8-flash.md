...
🔌 LLM APIs with free tier · no card · verified 2026-09-24 · listed since 2026-09-07
...
- Call it: `gemini-3.8-flash` at `https://generativelanguage.googleapis.com/v1beta/openai/`, with a key in `GOOGLE_AI_STUDIO_API_KEY` from <https://aistudio.google.com/apikey>
