---
layout: default
title: 'qwen3.5-35b-a3b free: 1 provider, limits and ids, verified 2026-09-24'
description: qwen3.5-35b-a3b is served free by Alibaba Cloud Model Studio (DashScope, international). It asks for no card. Each one's limits in the vendor's words, the ids to call and the day a live probe last confirmed it.
permalink: /models/qwen3.5-35b-a3b/
last_modified_at: 2026-09-26
crumb: qwen3.5-35b-a3b
---

{% raw %}

# Where qwen3.5-35b-a3b is free

**One row on the list serves `qwen3.5-35b-a3b` free:** Alibaba Cloud Model Studio (DashScope, international). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/qwen3-5-35b-a3b), below its strong bar.
