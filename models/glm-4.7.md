---
layout: default
title: 'glm-4.7 free: 1 provider, limits and ids, verified 2026-09-24'
...
**One row on the list serves `glm-4.7` free:** AIHubMix (free models). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/glm-4-7), below its strong bar.
