---
layout: default
title: 'qwen3.8-2.4t-a95b free: 1 provider, limits and ids, verified 2026-09-24'
...
**One row on the list serves `qwen3.8-2.4t-a95b` free:** Alibaba Cloud Model Studio (DashScope, international). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **strong**: within 25 points of the top of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/qwen3-8-2-4t-a95b).
...
- Call it: `qwen3.8-2.4t-a95b` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
