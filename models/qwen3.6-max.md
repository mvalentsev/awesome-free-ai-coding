...
# Where qwen3.6-max is free

**One row on the list serves `qwen3.6-max` free:** Alibaba Cloud Model Studio (DashScope, international). It asks for no card. A live probe confirmed it on 2026-09-24 and reads it again twice a week. It measures **notable**: in the upper half of the [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/qwen3-6-max), below its strong bar.
...
- Callable ids: `qwen3.6-max-preview`
