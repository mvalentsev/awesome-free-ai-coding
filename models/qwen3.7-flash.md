...
- Call it: `qwen3.7-flash` at `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`, with a key in `ALIBABA_MODEL_STUDIO_API_KEY` from <https://modelstudio.console.alibabacloud.com>
...
- Call it: `qwen/qwen3.7-flash:free` at `https://api.bazaarlink.ai/v1`, with a key in `BAZAARLINK_API_KEY` from <https://bazaarlink.ai/keys>
