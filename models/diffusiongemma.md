...
- Call it: `google/diffusiongemma-26b-a4b-it` at `https://integrate.api.nvidia.com/v1`, with a key in `NVIDIA_NIM_API_KEY` from <https://build.nvidia.com>
...
- Call it: `diffusiongemma` at `https://freeinference.org/v1`, with a key in `FREEINFERENCE_API_KEY` from <https://freeinference.org>
