...
CURATED_FEEDS = [
    ...
    # resolved (api.celebras.ai, a typo for Cerebras), it credits Cerebras with a
    # free lane that vendor's docs contradict, and it lists gateways serving
    # gpt-5.x and claude-* "free" — one of which, G4F, is already blocklisted here.
