...
Generated from `registry.yaml` on 2026-09-20. No probe reads this row any more — the list keeps one row per service; the full list, the Atom feed and the machinery are at <https://github.com/mvalentsev/awesome-free-ai-coding>.
