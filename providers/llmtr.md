...
description: 'Turkish OpenAI-compatible gateway with a daily-quota free lane that answers on a zero balance — eight zero-priced ids on 2026-09-08, Nemotron 3 Ultra, Qwen3.6 27B and Ling 3.0 Flash among them. The migration guide has a new account send its first request on a free model before any top-up: "Model…'
...
Turkish OpenAI-compatible gateway with a daily-quota free lane that answers on a zero balance — eight zero-priced ids on 2026-09-08, Nemotron 3 Ultra, Qwen3.6 27B and Ling 3.0 Flash among them
