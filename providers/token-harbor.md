...
OpenAI-compatible gateway with a $0 plan: explicit :free ids for DeepSeek V4.1 Flash, DeepSeek V4 Flash and MiMo V2.5 on a value-based allowance, no card

## Free models

`deepseek-v4.1-flash`, `mimo-v2.5`
...
- Note: the :free suffix selects the free route, which has to be switched on in the dashboard first; /v1/models needs a key, so the ids are the free rows the models page publishes (2026-09-16)
...
- Source: <https://tokenharbor.ai/models>
