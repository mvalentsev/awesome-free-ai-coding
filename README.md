...
| **[Windsurf](https://windsurf.com)** | Free plan + trial of paid tiers | — | <sub>The $0 plan is "Light quota to code with agents", "Limited model availability", unlimited inline edits and unlimited Tab completions. Which models that quota reaches is not published: "access to OpenAI, Claude, and Gemini frontier models" is what the $20 Pro plan adds, and the only mention of a small model anywhere on the page is a tip about making a quota last, not a plan feature. The page is now titled "Plans and Pricing | Devin" — Windsurf renders under Cognition's brand (read 2026-08-14)</sub> | ✅ No | `2026-08-13` |
...
<details>
<summary><b>🔭 Checked and not listed</b> — 36 services whose free tier this list could not find or could not verify, and what would change the answer</summary>
<br>
